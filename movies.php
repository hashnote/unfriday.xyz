...
.bottom-right88 {
 ...
 <head>
		...
		<link rel="stylesheet" type="text/css" href="./movies/style4.css" /> 
...
<a href="movies.php" ><p class="enginecolor">Movies</p></a>
<div class="example">	
<button><i class="fa fa-search" style="font-size:14px; color: #b1b1b1;"></i></button><input type="text" class="text1" maxlength="9999999" name="query_term" id="query_term"  placeholder="Search Movies..." />
</div>

<a id="mc" href="movies.php?query_term=&quality=2160p&genre=all&rating=0&sort_by=date-added" style="font: normal 14px monospace;float: right;padding: 8px 25px;border: 1px solid #252525;background-color: #121212;border-radius: 0px;color: white;">4K Movies</a>
...
<script>
    ...
    setInterval(function() {
        ...
        $("#mc").css("background", flag ? "green" : "");
			 ...
			 <div id="results"></div>
		<div class="searchmiddle2">
		<b style="margin-left:19px;"></b>
			  ...
			  <input class="text2" type="submit" value="Filter Search">
                  ...
                  <?php   if (!empty($title1)) {
                          ...
                          for ($y = 0; $y <= $countresults; $y++) {
									   ...
									   <div class="container02" id="container">
													<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="'.$image_url[$y].'" width="210" height="" class="lazyload">
                                       ...
                                       echo '<div class="titleofmovie"><font>'.$title1[$y].'</font></div>
										...
										<div class="column007" style="">
												<div style="font-size: .98em;color: #bbc6be; padding: 0px 0px 0px 2px;">'.$year[$y].'</div>												
										</div>
...
<div class="tooltip96"><i style="font-size:13px;color: #888;" class="fa fa-twitch"></i> Subtitles
...
<div class="tooltip97"><i style="font-size:13px;color: #888;" class="fa fa-photo"></i> Images 
...
<div class="tooltip98"><i style="font-size:13px;color: #888;" class="fa fa-address-card-o"></i> Details 
  <span class="tooltiptext98">'.$synopsis1[$y].'</span>
										...
										'; echo'<p>'.$complete_torrent_info1[$y].'</p>';
										
									   
												
                                       
                                       $imns = $y+1; echo '&emsp;&emsp;'; 
                                          echo ''; echo '<div id="#SUBs'.$imdb_code[$y].'"></div>'; echo '<div id=#ytlikes'.$yt_trailer_code1[$y].'></div></div>';
  ...
  <div id="mPlayer">  <div> </div>  </div> <!-- these divs for youtube popup and can be defined anywhere if there is problem in css then will display the video link in defined location -->
       ...
       <script type="text/javascript" src="movies/jquery.js"></script>
       <script type="text/javascript" src="movies/auto.js"></script>
	...
	<div style="text-align:center;"><a href="<?php echo $full_url1; ?>" class="home01">Home</a></le>&nbsp;&nbsp;&nbsp;<le><a href="<?php $page3 = $page1 - 1; $prev_page = $full_url1.'?page='.$page3."&quality=".$quality."&genre=".$genre."&rating=".$rating."&sort_by=".$sort_by."&query_term=".$query_term; echo $prev_page ?>"  class="home01"> &#8249; &#8249; Previous </a></le>&nbsp;&nbsp;&nbsp;<le><a href="<?php $page2 = $page1 + 1; $next_page = $full_url1.'?page='.$page2."&quality=".$quality."&genre=".$genre."&rating=".$rating."&sort_by=".$sort_by."&query_term=".$query_term;  echo $next_page ?>" class="home01"> Next &#8250; &#8250; </a></div>
	   <br>
	   <br>
	   <br>
	   <br>
