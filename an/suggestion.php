...
<!------ Include the above in your HEAD tag ---------->
	   ...
	   <link rel="stylesheet" href="./suggestion/movies.css">
...
<IFRAME style="margin: 0px;padding: 0px;overflow-x: hidden; display: inline-block;" SRC="ads2.php" FRAMEBORDER=0 MARGINWIDTH=0 MARGINHEIGHT=0 SCROLLING=NO WIDTH=100% HEIGHT=1px allowfullscreen></IFRAME>